...
Actual issuer:     $($existingFc.issuer)
Actual subject:    $($existingFc.subject)
Actual audiences:  $($existingFc.audiences -join ', ')
...
Write-Step "Ensuring RBAC assignment exists at Web App scope"
